(function(global) {
  ...
  TextHighlighter.prototype.doHighlight = function(
    ...
    if (this.options.onBeforeHighlight(range, flag) === true) {
      timestamp = +new Date();
  ...
  // just for bb-table
  TextHighlighter.prototype.highlightCustomRange = function(
    startEl,
    endEl,
    flag,
    flag2
    ...
    if (document.selection) {
      var textRange = wnd.document.body.createTextRange();
      textRange.moveStart(startEl, 0);
      textRange.moveEnd(endEl, 1);
      textRange.select();
      this.doHighlight(true, textRange, flag, flag2);
      textRange.collapse(false);
    } else if (wnd.getSelection) {
      var textRange = wnd.document.createRange();
      textRange.setStart(startEl, 0);
      textRange.setEnd(endEl, 1);
      this.doHighlight(true, textRange, flag, flag2);
      textRange.collapse(false);
    }
    wnd.scrollTo(scrollX, scrollY);
