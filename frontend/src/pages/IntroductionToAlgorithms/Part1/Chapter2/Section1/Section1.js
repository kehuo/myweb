...
export default class ShowAlgorithmsSectionPage extends ElementComponent {
  ...
  componentDidMount() {
    ...
    dispatch({
      ...
      // 传给后台的参数: 第part部分 第chapter章 第sectoin小节
      payload: {
        //id: id
        part: "1",
        chapter: "2",
    ...
    return (
      ...
      <Collapse defaultActiveKey={["1"]}>
        ...
        <Panel header="Explanation of the algorithm" key="2">
          <p>Building...</p>
          <a href="https://github.com/kehuo/algorithm_py3/">
        ...
        <Panel header="My code" key="4">
          <pre>{main.content.my_code}</pre>
        </Panel>
        <Panel header="Test my code" key="5">
          <input placeholder="type an array here" value="[4, 6, 3, 2, 7]" />
