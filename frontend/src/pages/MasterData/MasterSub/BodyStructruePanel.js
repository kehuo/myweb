...
import BodyStructurePopup from "./BodyStructurePopup";
import NodeSelectPopup from "./NodeSelectPopup";

import styles from "../MasterData.less";
let underscore = require("underscore");

export default class BodyStructruePanel extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      page: 1,
    ...
    return (
      <div style={{ width: 1000, backgroundColor: "white", padding: 10 }}>
        ...
        <NodeSelectPopup
          ...
          onMoreData={this.onMoreData.bind(this, "body_structure")}
        />
      </div>
    );
  }
