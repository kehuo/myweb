...
import ImpBodyParts from "./ImpBodyParts";
...
export default class BodyPartList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      page: 1,
  ...
  render() {
    const { data, total } = this.props.bodyPart;
