export default {
  ...
  // "menu.admin": "权限管理",
  // "menu.admin.organization-list": "机构列表",
  // "menu.admin.department-list": "科室列表",
  // "menu.admin.role-list": "角色列表",
  // "menu.admin.user-list": "用户列表",
  // "menu.admin.feedback-list": "反馈列表",

  "menu.common": "公共数据",
  "menu.common.data-source-list": "数据源管理",
  "menu.common.body-part-list": "身体部位管理",
  "menu.common.disease-system-list": "疾病系统管理",
  "menu.common.disease-list": "疾病管理",
  "menu.common.org-suggest-format": "机构推荐格式",
  "menu.common.department-ui-list": "科室UI配置",

  // 'menu.data': '采集数据',
  // 'menu.data.operator': '操作者信息',
  // 'menu.data.visit-info': '推送信息',
  // 'menu.data.log-info': '日志信息',

  "menu.template": "模板管理",
  "menu.template.virtual-department-list": "虚拟组",
  "menu.template.model-list": "模型描述",
  "menu.template.model-source-list": "模型配置",
  "menu.template.template-list": "模板列表",
  "menu.template.physical-segment-list": "体格检查片段",
  "menu.template.entity-segment-list": "症状片段",
  "menu.template.associated-symptom-list": "症状关联",
  "menu.template.package-list": "疾病模板列表",
  "menu.template.package-editor": "编辑疾病模板",
  "menu.template.template-test": "疾病模板测试",
  "menu.template.vd-package-list": "虚拟组模板列表",
  "menu.template.vd-package-editor": "编辑虚拟组模板",
  "menu.template.department-ai-config": "科室配置",
  "menu.template.doctor-template": "模板演进跟踪",

  "menu.medicine-suggest": "处方推荐",
  "menu.medicine-suggest.std-medicine-list": "标准药品管理",
  "menu.medicine-suggest.org-medicine-list": "机构药品管理",
  "menu.medicine-suggest.medicine-mapping": "药品映射",

  "menu.exam-suggest": "检查推荐",
  "menu.exam-suggest.exam-list": "检验和检查管理",
  "menu.exam-suggest.disease-exam-list": "疾病检查匹配",

  "menu.rare-disease": "罕见病模块",
  "menu.rare-disease.cn-list": "中国罕见病",
  "menu.rare-disease.world-list": "国际罕见病",
  "menu.rare-disease.cn-mapping-list": "罕见病映射",
  "menu.rare-disease.hpo-list": "HPO表征",
  "menu.rare-disease.rare-hpo-mapping-list": "罕见病HPO映射",

  "menu.third-party": "第三方管理",
  "menu.third-party.hpo-list": "HPO信息",
  "menu.third-party.heredopathia-hpo-list": "遗传病信息",
  "menu.third-party.interface-list": "接口信息",

  "menu.tagging-normal": "标注归一",
  "menu.tagging-normal.master-panel": "主数据管理",
  "menu.tagging-normal.normal-panel": "归一管理",
  "menu.tagging-normal.tagging-list": "标注管理",
  "menu.tagging-normal.hpo-mapping": "HPO映射",
  "menu.tagging-normal.total-test": "效果测试",

  "menu.train-model": "模型训练",
  "menu.train-model.tagging-model": "标注模型训练",
  "menu.train-model.structure-model": "结构化模型训练",
  "menu.train-model.surreal-model": "预测模型训练",
  "menu.train-model.test": "测试页面",
  //'menu.train-model.task-list': '训练任务列表',
  //'menu.train-model.task-detail': '训练任务细节',

  "menu.system-operation": "系统运维",
  "menu.system-operation.health-check": "系统运行情况",
  "menu.system-operation.visit-info-debug": "推送信息调试",
  "menu.system-operation.track-log-debug": "跟踪日志调试",
  "menu.system-operation.track-auth-list": "操作日志",

  // 'menu.referral': '转诊',
  // 'menu.referral.referral-statistics': '转诊统计',
  // 'menu.referral.referral-accept-statistics': '转诊接收统计',
  // 'menu.referral.user-operation-statistics': '用户使用统计',
  //
  // 'menu.primary-health-stats': '基层医疗机构统一平台',
  // 'menu.primary-health-stats.overview': '平台概览',
  // 'menu.primary-health-stats.org-stats-detail': '机构统计',

  "menu.statistics": "平台统计",
  "menu.statistics.mix-panel": "使用统计",
  "menu.statistics.overview": "平台概览",
  "menu.statistics.org-stats-detail": "机构统计",
  "menu.statistics.referral-statistics": "转诊统计",
  "menu.statistics.referral-accept-statistics": "转诊接收统计",

  "menu.dashboarder-builder": "仪表盘配置",
  "menu.demo": "演示",
  "menu.demo.structure": "结构演示",
  "menu.demo.statistics": "统计演示",
  "menu.demo.emr": "病历演示",

  "menu.doctor-community": "医生合作社区",
  "menu.doctor-community.emr-case": "病历甄别",
  "menu.doctor-community.export-nlp": "结构化展示",
  "menu.doctor-community.show-nlp": "结构化展示子页",

  //检查报告结构化
  "menu.exam-standard": "检查报告展示",
  "menu.exam-standard.emr-case": "病历甄别",
  "menu.exam-standard.show-exam-report-list": "检查报告结构化展示",
  "menu.exam-standard.show-exam-report-result-one": "检查报告结构化展示子页",
  "menu.exam-standard.prototype-list": "草案展示",
  "menu.exam-standard.prototype-one": "草案展示子页",
  "menu.exam-standard.ramdis-list": "Ramdis",
  "menu.exam-standard.ramdis-one": "Ramdis子页",
  "menu.exam-standard.loinc-list": "LOINC",
  "menu.exam-standard.radlex-list": "Radlex",
  "menu.exam-standard.radlex-mapping-list": "Radlex映射",
  "menu.exam-standard.loincObj-mapping-list": "LoincObj映射",
  "menu.exam-standard.loincStep0-mapping-list": "LoincStep0映射",
  "menu.exam-standard.fma-list": "FMA",
  "menu.exam-standard.snomed-ct-list": "SNOMED-CT",
