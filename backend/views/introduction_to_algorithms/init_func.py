...
from views.introduction_to_algorithms.view_func_builder import IntroductionToAlgorithmsViewFuncBuilder
...
def introduction_to_algorithms_init_func(app, global_var):
    ...
    # 2
    introduction_to_algorithms_view_func_builder = IntroductionToAlgorithmsViewFuncBuilder(global_var)
