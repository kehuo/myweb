...
CREATE TABLE `user` (
  ...
  `user_id` varchar(64) UNIQUE NOT NULL COMMENT '用户唯一id, 使用uuid5生成',
...
CREATE TABLE `comment` (
  ...
  `comment_id` varchar(64) UNIQUE NOT NULL DEFAULT '' COMMENT '每条评论的一条唯一编号, uuid5生成',
  `content` varchar(128) NOT NULL DEFAULT '' COMMENT '具体评论的内容',
  `creator_user_id` varchar(128) NOT NULL DEFAULT "" COMMENT '评论的user_id',
